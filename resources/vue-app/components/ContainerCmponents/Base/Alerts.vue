    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">Alerts</h3>
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="m-section__content">
                                ...
                                <div class="alert alert-brand" role="alert">
                                    <strong>Brand!</strong> You successfully read this important alert message.
                                </div>
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="m-alert m-alert--icon m-alert--outline alert alert-primary" role="alert">
                                ...
                                <div class="m-alert__actions" style="width: 200px;">
                                    <button type="button" class="btn btn-brand btn-sm m-btn m-btn--pill m-btn--wide">Fix
                                    </button>
                                    <button type="button" class="btn btn-danger btn-sm m-btn m-btn--pill m-btn--wide" data-dismiss="alert" aria-label="Close">Dismiss
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="m-alert m-alert--icon alert alert-accent" role="alert">
                                ...
                                <div class="m-alert__text">
                                    <strong>Well done!</strong> Dismiss will remove it permanently!
                                </div>
                                <div class="m-alert__close">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    </button>
                            ...
                            <div class="m-alert m-alert--icon alert alert-warning" role="alert">
                                ...
                                <div class="m-alert__text">
                                    <strong>Well done! Dismiss will just hide me, i will not be removed!</strong>
                                </div>
                                <div class="m-alert__close">
                            ...
                            <div class="m-alert m-alert--icon alert alert-primary" role="alert">
                                ...
                                <div class="m-alert__actions" style="width: 160px;">
                                    <button type="button" class="btn btn-warning btn-sm m-btn m-btn--pill m-btn--wide">Fix
                                    </button>
                                </div>
                            </div>
