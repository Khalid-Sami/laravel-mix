                ...
                <div class="m-portlet__body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-metal" data-toggle="modal" data-target="#m_modal_1_2"> Launch Modal</button>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 30%">Scrolling long content</td>
                            <td>
                                <button type="button" class="btn btn-brand" data-toggle="modal" data-target="#m_modal_2"> Launch Modal</button>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 30%">Tooltips and popovers</td>
                            <td>
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#m_modal_3"> Launch Modal</button>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#m_modal_5">Launch Modal</button>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 30%">Vertically centered</td>
                            <td>
                                <button type="button" class="btn btn-focus" data-toggle="modal" data-target="#m_modal_6">Launch Modal</button>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="modal fade" id="m_modal_2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>
                                Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Cras mattis consectetur purus sit amet fermentum. Cras justo
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>This <a href="#" role="button" data-toggle="m-popover" class="btn btn-secondary popover-test" title="Popover title" data-content="Popover body content is set in this attribute.">button</a> triggers a popover on click.</p>
                            <hr>
                            <h5>Tooltips in a modal</h5>
                            <p><a href="#" class="tooltip-test" data-toggle="m-tooltip" title="Tooltip">This link</a> and <a href="#" data-toggle="m-tooltip" class="tooltip-test" title="Tooltip">that link</a> have tooltips on hover.</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-primary">Save changes</button>
